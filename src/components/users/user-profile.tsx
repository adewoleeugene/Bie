...
/**
 * Shared profile view, rendered at both `/profile` (the signed-in user's own,
 * canonical URL) and `/users/[id]` (anyone's). Keeping the data-fetch + layout
 * in one place means the two routes never drift apart.
 */
export async function UserProfileView({ userId }: { userId: string }) {
